<?php
	$author_name = "Siim";
	//palceholderid
	$title_form_placeholder = 'Filmi pealkiri';
	$year_form_placeholder = '';
	$duration_form_placeholder = '60';
	$genre_form_placeholder = 'Žanr';
	$studio_form_placeholder = 'Filmi tootja';
	$director_form_placeholder = 'Režissöör';
...
<div class="content">
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
		...
		<input type="text" name="title_input" id="title_input" placeholder="<?php echo $title_form_placeholder; ?>" required>
		<br />
		<label for="year_input">Valmimisaasta</label>
		<input type="number" name="year_input" id="year_input" min="1912"  >
		<br />
		<label for="duration_input">Kestus</label>
		<input type="number" name="duration_input" id="duration_input" min="1" placeholder="<?php echo $duration_form_placeholder; ?>" max="600" required>
		<br />
		<label for="genre_input">Žanr</label>
		<input type="text" name="genre_input" id="genre_input" placeholder="<?php echo $genre_form_placeholder; ?>" required>
		<br />
		<label for="studio_input">Filmi tootja</label>
		<input type="text" name="studio_input" id="studio_input" placeholder="<?php echo $studio_form_placeholder; ?>" required>
		<br />
		<label for="director_input">Režissöör</label>
		<input type="text" name="director_input" id="director_input" placeholder="<?php echo $director_form_placeholder; ?>" required> 
		<br />
